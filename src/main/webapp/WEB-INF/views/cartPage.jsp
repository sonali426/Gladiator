...
<a href = "${pageContext.request.contextPath}/order/placeOrder"> Place Order </a> --%>
...
<body>
	...
	<div id="wrapper" class="container">
		...
		<section class="header_text sub">
			<img class="pageBanner" src="${pageContext.request.contextPath}/images/pageBanner.png" alt="New products" >
				...
				<div class="row">
					<div class="span9">					
						...
						<table class="table table-striped">
							...
							<c:forEach items="${customerProductList}" var = "customerProductList">
							<tbody>
								<tr>
									
									<td><a href="product_detail.html"><img alt="" src="${pageContext.request.contextPath}/images//9.jpg" style="width:50px;height:60px;"></a></td>
									<td>${customerProductList.productName}</td>
									<td>${customerProductList.productPrice}</td>
						...
						<p class="buttons center">				
							<button class="btn" type="button"><a href="${pageContext.request.contextPath}/product/showProductList/${categoryId}">Continue</button>
	...
	<section id="footer-bar">
		<div class="row">
			...
			<div class="span5">
				<p class="logo">
					<img src="${pageContext.request.contextPath}//images/logo.png" class="site_logo" alt="">
				</p>
