...
<body>
	...
	<div id="wrapper" class="container">
		...
		<h1>You have successfully logged out. Thank you for visiting!!!</h1>
		<br>
		<br>
		<br> <a class="btn btn-secondary fixed-right"
			href="${pageContext.request.contextPath}/" role="button">BACK</a> <br>
		<br>
		<br>
	</div>
	<div id="wrapper" class="container">
